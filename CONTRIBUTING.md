...
- [docs/architecture-diagram.md](docs/architecture-diagram.md) — Mermaid workflow diagrams
- [docs/trust-foundation.md](docs/trust-foundation.md) — why trust this workflow (long form)
- [LICENSE](LICENSE) — MIT
